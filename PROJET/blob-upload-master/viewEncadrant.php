...
?>
   ...
   <a href="indexEncadrant.php"><button type="button" class="btn btn-primary " style="margin-top: 30px;margin-left: 128px;"><i class="fa fa-arrow-left"></i> Précédent</button></a> 
</div>
