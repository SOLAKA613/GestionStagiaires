...
{	
$password =$bdd->query("select COUNT(PASSWORD) AS NBPASSWORD from information_encadrant where PASSWORD='".$_POST["Ancpass"]."'");
$Enca_pass = $password->fetch();

if($Enca_pass['NBPASSWORD']!=0)
{	
$updatepassword =$bdd->query("UPDATE information_encadrant SET PASSWORD='".$_POST["Newpass"]."'");
