...
{	
$password =$bdd->query("select COUNT(PASSWORD) AS NBPASSWORD from etudiant_inscrit where PASSWORD='".$_POST["Ancpass"]."'");
$Etudiant_pass = $password->fetch();

if($Etudiant_pass['NBPASSWORD']!=0)
{	
$updatepassword =$bdd->query("UPDATE etudiant_inscrit SET PASSWORD='".$_POST["Newpass"]."'");
