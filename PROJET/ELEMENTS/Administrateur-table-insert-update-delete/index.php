...
$fil = "";
$cycle = "";
if(isset($_POST) && isset($_POST["fil"]) && isset($_POST['cycle']))
{
	$cycle = $_POST['cycle'];	
	if($cycle == "LICENCE")
	{
...
<li class="active stage" style="margin-left: 52px;"><a href="http://localhost/PROJET_STAGE/PROJET/ELEMENTS/Administrateur-table-insert-update-delete/Choisir_filiere.php"><i class="fa fa-user-graduate fa-2x"></i> Stagiaires</a>
</li>
...
<li class="active">
                    <a href="#" ><i class="fas fa-key " style='font-size: 29px;'></i><span style="font-size:14px;"> MOT DE PASSE</span> <i class="fa fa-sort-desc" aria-hidden="true"></i></a>
...
<html>
	...
	<body>
		<div class="container box">
			<h1 align="center"><?php echo "Voir monsieur la liste des étudiants inscrit dans la cycle " . $cycle . " et  filière " . $fil; ?> </h1>
			<br />
...
$(document).ready(function(){
	...
	$('#add_button').click(function(){
		document.getElementById("CNE").style="display:block";
				document.getElementById("CNEA").style="display:none";
		...
		$('#user_form')[0].reset();
		$('.modal-title').text("Ajouter un étudiant");
		$('#action').val("Ajouter").style="display: inline-block;margin-top: auto;";
		$('#operation').val("Add");
