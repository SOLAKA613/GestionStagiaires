...
{    
		...
		||$ext=="XLS"||$ext=="xls"||$ext=="XLSX"||$ext=="xlsx"||$ext=="xlsm"||$ext=="XLSM")
	{
	    ...
	    $sql="UPDATE rapport SET RAPPORT='$filename',TYPE='$file_type',SIZE='$file_size',DATE_DEPOT='$DATE' where rapport.ID_STAGE=".$ID_STA['ID_STAGE'];
		...
		window.location.href='indexEtudiant.php';
        </script>
		<?php
