...
<?php
session_start();
$_SESSION['NNN']=$_SESSION['NOM'] . " " . $_SESSION['PRENOM'];
include('db.php');
...
{
	$query .= 'WHERE et.CNE=gr.CNE AND gr.ID_GROUPE=st.ID_GROUPE AND st.ENCADRANT="'.$_SESSION['NNN'].'" AND et.CNE LIKE "%'.$_POST["search"]["value"].'%" ';
