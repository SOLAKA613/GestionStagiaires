...
<li class="active stage" style="margin-left: 1px;"><a href="http://localhost/PROJET_STAGE/PROJET/blob-upload-master/indexAdministrateur.php" title=""><i class="fa fa-book fa-2x"></i> Rapports</a></li>
...
?>
   ...
   <a href="indexAdministrateur.php"><button type="button" class="btn btn-primary " style="margin-top: 30px;margin-left: 128px;"><i class="fa fa-arrow-left"></i> Précédent</button></a> 
</div>
...
<footer class=" container-fluid footbot text-center breadcrumb " style="width: 1348px;">
		<div class="container">
