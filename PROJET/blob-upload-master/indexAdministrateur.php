...
<li class="active stage"><a href="http://localhost/PROJET_STAGE/PROJET/blob-upload-master/indexAdministrateur.php" title=""><i class="fa fa-book fa-2x"></i> Rapports</a></li>
...
<div class="panel panel-default"style="height: 501px;">
  ...
  <div class="panel-body" style="height: 501px;">
   ...
   <div class="row">
    ...
    <form action="uploadAdministrateur.php" method="post" enctype="multipart/form-data" id="signup-form" class="form-horizontal" role="form"  accept-charset="utf-8" novalidate="novalidate" onsubmit="return Validate()" name="vform">
 ...
 <a href="viewAdministrateur.php"><button type="button" class="btn btn-success">Voir la table des rapports</button></a>
     </div>
