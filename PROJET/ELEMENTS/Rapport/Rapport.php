...
$Rapport=$bdd->query('select * FROM `information_rapport`  ');
?>
...
<nav class="navbar navbar-default navbar-inverse navbar-fixed-top " role="navigation" ><!--navbar-fixed-top:pour fixer la parite en haut qui est responsable sur la recherche laurs de déplacement de page -->
  ...
  <div class="navbar-header" style="height:53px; ">
   ...
   <div class="collapse navbar-collapse AA " id="bs-example-navbar-collapse-1">
	...
	<li class="nav navbar-nav">
	<li class="dropdown">
	<a class="btn btn-secondary "  id="dropdownMenuButton" data-toggle="dropdown"  ><i class="fa fa-sign-out-alt"></i>
	Se connecter</a>
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
	<div class="deconnecte actif breadcrumb">
		<div class="logge" style="display: block;">
			...
			<div class="form-group">
            <label for="exampleDropdownFormPassword1">Nom d'utilisateur :</label>
...
<li class="active stage" style="margin-left:1px;"><a href="http://localhost/PROJET_STAGE/PROJET/ELEMENTS/Rapport/Rapport.php"  title=""><i class="fa fa-book fa-2x"></i> Rapports</a></li>
                              </ul>							
						</div>
					</div>
			</nav>	
	...
	<!--Start table-->
<div class="ta">	
<table class="table table-bordered" style="width:630px; margin-left: 361px; background-color:#fff;">
 <caption>Bonjour Monsieur,voir la liste des rapports  </caption>
 <thead class="thead-light">
<tr>
	<th scope="col" >#</th>
	<th scope="col" >SUJET</th>	  
	<th scope="col" style="width: 185px;">DATE_DEPOT</th>  
</tr>
 </thead>
<tbody>
  <tr>
